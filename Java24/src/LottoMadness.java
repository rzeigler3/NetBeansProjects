...
public class LottoMadness extends JFrame {
    ...
    JLabel yourPicksLabel = new JLabel("Your Picks:");
    JTextField[] yourPicks = new JTextField[6];
    ...
    JLabel got3Label = new JLabel("3 of 6:");
    JTextField got3 = new JTextField();
    JLabel got4Label = new JLabel("4 of 6:");
    JTextField got4 = new JTextField();
    JLabel got5Label = new JLabel("5 of 6:");
    JTextField got5 = new JTextField();
    JLabel got6Label = new JLabel("6 of 6:");
    JTextField got6 = new JTextField();
    JLabel drawingsLabel = new JLabel("Drawings:");
    ...
    public LottoMadness() {
        ...
        GridLayout layout = new GridLayout(5, 10, 10, 10);
        setLayout(layout);
        ...
        row2.add(yourPicksLabel);
        for (int i = 0; i < yourPicks.length; i++) {
            yourPicks[i] = new JTextField();
            row2.add(yourPicks[i]);
        }
    ...
    public static void main(String[] args) {
        LottoMadness lm = new LottoMadness();
    }
}